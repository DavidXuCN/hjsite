...
def send_notification(sender, instance, **kwargs):
    ...
    if instance.reply_to is None:
        ...
        if instance.content_type.model == 'blog':
            ...
            verb = '{0} commented on your "{1}"'.format(
                    instance.user.get_nickname_or_username(), blog.title
                )
        else:
        ...
        verb = '{0} replied to your comment "{1}"'.format(
...
def send_email(sender, instance, **kwargs):
    ...
    if instance.parent is None:
            # 评论我的博客
            # 发送邮件
            subject = 'Someone comment your blog 【www.huijia-cn.com】'
            email = instance.content_object.get_email()
    else:
        # 回复评论
        # 发送邮件
        subject = 'Someone reply your comment 【www.huijia-cn.com】'
